...
image::pscom-init-cleanup.svg[pscom init and cleanup]
...
image::pscom-connectivity-instant.svg[pscom instant connectivity]
...
image::pscom-connectivity-ondemand.svg[pscom on-demand connectivity]
...
image::pscom-msg-recv.svg[pscom message reception network side]
...
image::pscom-msg-send.svg[pscom send request]
