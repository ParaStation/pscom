...
#if defined(T3_JUMBO_RCB_ENTRY_COUNT) && T3_JUMBO_RCB_ENTRY_COUNT
...
#define DEFAULT_RX_MAX_COALESCED_FRAMES     1 /* 6 */
#else
#define DEFAULT_RX_COALESCING_TICKS         60
#define DEFAULT_RX_MAX_COALESCED_FRAMES     1 /* 15 */
#endif

#define DEFAULT_TX_COALESCING_TICKS         200
#define DEFAULT_TX_MAX_COALESCED_FRAMES     1 /* 35 */
