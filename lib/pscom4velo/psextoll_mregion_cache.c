...
static inline int psex_mregion_is_inside(psex_mregion_cache_t *mregc, void *buf,
                                         size_t size)
{
...
static psex_mregion_cache_t *psex_mregion_find(void *buf, size_t size)
{
    struct list_head *pos;
    list_for_each (pos, &psex_mregion_cache) {
        psex_mregion_cache_t *mregc = list_entry(pos, psex_mregion_cache_t,
                                                 next);
        if (psex_mregion_is_inside(mregc, buf, size)) { return mregc; }
    }
...
static void psex_mregion_enq(psex_mregion_cache_t *mregc)
{
...
static void psex_mregion_deq(psex_mregion_cache_t *mregc)
{
    list_del(&mregc->next);
    psex_mregion_cache_size--;
}
...
static void psex_mregion_use_inc(psex_mregion_cache_t *mregc)
{
    mregc->use_cnt++;
...
static void psex_mregion_use_dec(psex_mregion_cache_t *mregc)
{
    mregc->use_cnt--;
}


static psex_mregion_cache_t *psex_mregion_create(void *buf, size_t size,
                                                 RMA2_Port rma2_port)
{
    psex_mregion_cache_t *mregc = (psex_mregion_cache_t *)malloc(
        sizeof(psex_mregion_cache_t));
    int err;
...
static void psex_mregion_destroy(psex_mregion_cache_t *mregc)
{
...
static void psex_mregion_gc(unsigned max_size)
{
...
static void psex_mregion_cache_cleanup(void)
{
    psex_mregion_gc(0);
