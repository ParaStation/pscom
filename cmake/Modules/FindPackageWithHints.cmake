function(find_package_with_hints package search_path header_names lib_names doc)
  ...
  set(${uc_package}_LIBRARIES
      ${${uc_package}_LIBRARY}
      PARENT_SCOPE)
  set(${uc_package}_INCLUDE_DIRS
      ${${uc_package}_INCLUDE_DIR}
      PARENT_SCOPE)
  ...
  find_package_handle_standard_args(
    ${package} DEFAULT_MSG ${uc_package}_LIBRARY ${uc_package}_INCLUDE_DIR)

  # Change the visibility of the resulting ${uc_package}_FOUND variable
  set(${uc_package}_FOUND
      ${${uc_package}_FOUND}
      PARENT_SCOPE)
endfunction()
