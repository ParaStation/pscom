...
#define TEST_GROUP_SIZE(test_group)                                            \
    (sizeof(test_group) / sizeof(struct CMUnitTest))
...
int main(void)
{
    ...
    const struct CMUnitTest pscom_io_tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_post_recv_partial_genreq,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_recv_genreq_state,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_recv_on_con, setup_dummy_con,
                                        teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_any_recv_on_sock,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_any_recv_on_global_queue,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
            test_post_recv_on_con_after_any_recv_on_sock, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
        ...
        cmocka_unit_test_setup_teardown(
            ...
            setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_recv_on_con_and_cancel,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_any_recv_on_sock_and_cancel,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
            test_post_any_recv_on_global_queue_and_cancel, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_post_recv_on_con_and_terminate_recvq,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
            test_post_any_recv_on_sock_and_terminate_recvq, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
        ...
        cmocka_unit_test_setup_teardown(
            test_pscom_get_rma_read_receiver_failing_rma_write, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_rndv_recv_read_error,
                                        setup_dummy_con_pair,
                                        teardown_dummy_con_pair),
        cmocka_unit_test_setup_teardown(test_write_pending_first_io_con_closed,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_write_pending_first_io_con_open,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_write_pending_done_last_io,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_write_pending_done_second_last_io,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_read_pending_done_unrelated_genreq,
                                        setup_dummy_con, teardown_dummy_con),
    };
    total_tests += TEST_GROUP_SIZE(pscom_io_tests);
    failed_tests += cmocka_run_group_tests(pscom_io_tests, NULL, NULL);

    /* pscom_listener tests */
    const struct CMUnitTest pscom_listener_tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_start_stop_listen_ondemand_recv_req,
                                        setup_dummy_sock, teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(test_suspend_listen, setup_dummy_sock,
                                        teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(test_suspend_resume_listen,
                                        setup_dummy_sock, teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(test_suspend_resume_listen_ondemand,
                                        setup_dummy_sock, teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(
    ...
    const struct CMUnitTest pscom_env_tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_uint_default,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_uint,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_uint_inf,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_uint_auto,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_uint_typo,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_int_default,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_int,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_int_empty,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(
            test_env_table_parse_single_size_t_default, backup_test_val_env,
            restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_size_t,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_size_t_typo,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_str_default,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_str,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_dir_default,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_single_dir,
                                        backup_test_val_env,
                                        restore_test_val_env),
        cmocka_unit_test_setup_teardown(test_env_table_parse_multi_entry,
                                        backup_three_test_val_env,
                                        restore_three_test_val_env),
        cmocka_unit_test_setup_teardown(
            test_env_table_parse_multi_entry_failing_entry,
            backup_three_test_val_env, restore_three_test_val_env),
        cmocka_unit_test_setup_teardown(
            test_env_table_parse_single_size_t_parent_set,
            backup_test_val_env_and_parent, restore_test_val_env_and_parent),
        cmocka_unit_test_setup_teardown(
        ...
        cmocka_unit_test_setup_teardown(
            test_env_table_register_and_parse_env_var, backup_test_val_env,
            restore_test_val_env),
    ...
    const struct CMUnitTest pscom_debug_tests[] = {
        cmocka_unit_test_setup_teardown(test_debug_psp_debug_out_max_debug_level,
                                        backup_env_vars, restore_env_vars),
        cmocka_unit_test_setup_teardown(test_debug_precon_broken_pipe,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_debug_precon_io_error,
                                        setup_dummy_con, teardown_dummy_con),
    };
    ...
    const struct CMUnitTest pscom4portals_tests[] = {
        cmocka_unit_test_setup_teardown(test_portals_first_initialization,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_second_initialization,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_initialization_after_failure,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_creates_arch_sock,
                                        setup_dummy_sock, teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(
        ...
        cmocka_unit_test_setup_teardown(
            ...
            setup_dummy_sock, teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(
            test_portals_arch_sock_is_correctly_removed, setup_dummy_sock,
            teardown_dummy_sock),
        cmocka_unit_test_setup_teardown(
            test_portals_initialization_after_socket_failure, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_read_after_con_read,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(
            test_portals_read_after_con_read_stop_out_of_two, setup_dummy_con,
            teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_one_reader_per_socket,
                                        setup_dummy_con, teardown_dummy_con),
        cmocka_unit_test_setup_teardown(test_portals_read_on_event_put,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_read_out_of_order_receive,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(
            test_portals_read_three_out_of_order_receive,
            setup_dummy_portals_con, teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_read_after_send_request,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_put_fail,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(
        ...
        cmocka_unit_test_setup_teardown(test_portals_handle_message_drop,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_memory_registration,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_failed_memory_registration,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(
            test_portals_mem_deregister_releases_resources,
            setup_dummy_portals_con, teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_rma_write,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_rma_write_fragmentation,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(
            test_portals_rma_write_fragmentation_remainder,
            setup_dummy_portals_con, teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_rma_write_fail_put,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_rma_write_completion,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
        cmocka_unit_test_setup_teardown(test_portals_rma_write_fail_ack,
                                        setup_dummy_portals_con,
                                        teardown_dummy_portals_con),
    };
    ...
    const struct CMUnitTest pscom_cuda_tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_cuda_cleanup_destroys_cuda_streams,
                                        setup_dummy_streams,
                                        clear_dummy_streams),
        ...
        cmocka_unit_test_setup_teardown(
            test_cuda_cleanup_for_failing_stream_destroy, setup_dummy_streams,
            clear_dummy_streams),
        ...
        cmocka_unit_test_setup_teardown(
            ...
            setup_dummy_streams, clear_dummy_streams),
        cmocka_unit_test(
            test_pscom_memcpy_gpu_safe_from_user_creates_cuda_stream),
        cmocka_unit_test(test_pscom_memcpy_gpu_safe_to_user_host_mem),
        cmocka_unit_test_setup_teardown(
            test_pscom_memcpy_gpu_safe_to_user_device_mem, setup_dummy_streams,
            clear_dummy_streams),
        cmocka_unit_test(test_pscom_memcpy_gpu_safe_default_host_mem),
        cmocka_unit_test_setup_teardown(
            test_pscom_memcpy_gpu_safe_default_device_mem, setup_dummy_streams,
            clear_dummy_streams),
        cmocka_unit_test(test_pscom_memcpy_host_mem),
        cmocka_unit_test(test_pscom_memcmp_gpu_safe_equal),
        cmocka_unit_test(test_pscom_memcmp_gpu_safe_larger),
        cmocka_unit_test(test_pscom_memcmp_gpu_safe_smaller),
        cmocka_unit_test_setup_teardown(test_pscom_stage_buffer_dev_mem_no_con,
                                        setup_dummy_streams,
                                        clear_dummy_streams),
        cmocka_unit_test(test_pscom_stage_buffer_host_mem),
        cmocka_unit_test_setup_teardown(test_pscom_unstage_buffer_dev_mem,
                                        setup_dummy_streams,
                                        clear_dummy_streams),
